...
- Q2) Build a cluster from scratch and How hard is it to repeat ? 
- Q3) It still easily manageable and scalable ?
- Q4) Ready to build an applications with velocity to run in a Cloud-Native Environment ?
